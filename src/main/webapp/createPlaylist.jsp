...
<head>
    ...
    <!-- Title -->
    <title>One Music - Create Playlist</title>
...
<section class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/bg-img/breadcumb3.jpg);">
    <div class="bradcumbContent">
        <p>One  way  to  forget  pain  is  to  do  something  you  will  be  in,  completely.</p>
        <p>So,  coding...</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input name = "uid" value="${sessionScope.acc.uid}" style="display: none">
                                    <input name="playListName" type="text" class="form-control" placeholder="Name of your playlist:">
                                </div>
                            </div>
                            <div class="col-12 text-center">
                                <button class="btn oneMusic-btn" type="submit" style="margin-bottom: 15px">Create<i class="fa fa-angle-double-right"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
